export default {
  ...
  head: {
    ...
    feedback: { title: 'Feedback', dek: 'Spotted something off or have a feature idea? Drop it here.' },
  },
  headings: {
  ...
  feedback: {
    title: 'Feedback',
    dek: 'Spotted something off or have a feature idea? Drop it here — keep it short.',
    messageLabel: 'Message',
    messagePlaceholder: 'What should be fixed, added, or changed…',
    ...
    successBody: 'Thanks for the feedback!',
    sendAgain: 'Send another',
    errorDefault: 'Failed to send feedback. Please try again.',
    charCount: '{count}/500',
    deleteConfirm: 'Delete this feedback?',
    deletedToast: 'Feedback deleted',
    deleteFailed: 'Failed to delete feedback',
    loadFailed: 'Failed to load feedback',
    statusNew: 'New',
    statusRead: 'Read',
    toggleReadToast: 'Marked as read',
    toggleNewToast: 'Marked as new',
