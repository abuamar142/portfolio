export default {
  ...
  head: {
    ...
    feedback: { title: 'Feedback', dek: 'Ada yang kurang atau ada ide fitur? Tulis singkat di sini.' },
  },
  headings: {
  ...
  feedback: {
    title: 'Feedback',
    dek: 'Ada yang kurang atau ada ide fitur? Tulis singkat di sini.',
    messageLabel: 'Pesan',
    messagePlaceholder: 'Abaikan yang perlu diperbaiki, ditambah, atau diubah…',
    messageRequired: 'Pesan wajib diisi',
    contactLabel: 'Kontak (opsional)',
    contactPlaceholder: 'Hanya jika ingin dibalas',
    submit: 'Kirim',
    submitting: 'Mengirim…',
    successTitle: 'Pesan terkirim',
    successBody: 'Terima kasih atas feedback-nya!',
    sendAgain: 'Kirim lagi',
    errorDefault: 'Gagal mengirim feedback. Silakan coba lagi.',
    charCount: '{count}/500',
    deleteConfirm: 'Hapus feedback ini?',
    deletedToast: 'Feedback dihapus',
    deleteFailed: 'Gagal menghapus feedback',
    loadFailed: 'Gagal memuat feedback',
    statusNew: 'Baru',
    statusRead: 'Dibaca',
    toggleReadToast: 'Ditandai sudah dibaca',
    toggleNewToast: 'Ditandai belum dibaca',
    toggleFailed: 'Gagal memperbarui status',
    empty: 'Belum ada feedback.',
  },
  theme: {
    label: 'Tema',
    system: 'Sistem',
