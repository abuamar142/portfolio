...
useHead({
  title: computed(() => t('links.title')),
  meta: [
    { name: 'description', content: computed(() => t('links.dek')) },
    { property: 'og:title', content: computed(() => `${t('links.title')} - Abu Amar`) },
    { property: 'og:description', content: computed(() => t('links.dek')) },
  ],
})
