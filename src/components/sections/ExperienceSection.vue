<template>
  ...
  >
    ...
    <div class="absolute inset-0">
      <div
        class="absolute top-32 right-10 w-80 h-80 bg-dracula-purple/10 rounded-full blur-3xl"
      ></div>
      <div
        class="absolute bottom-32 left-10 w-64 h-64 bg-dracula-pink/10 rounded-full blur-3xl"
      ></div>
    </div>
    ...
    <div class="relative max-w-7xl mx-auto px-6">
      ...
      <div class="relative">
        <!-- Timeline Line -->
        <div
          class="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-dracula-purple via-dracula-purple to-dracula-pink"
        ></div>

        <div class="space-y-16 animate-slide-up delay-200">
          <div
          ...
          >
            <!-- Timeline Dot -->
            <div
              class="absolute left-6 w-4 h-4 bg-gradient-to-r from-dracula-purple to-dracula-pink rounded-full shadow-glow group-hover:scale-125 transition-transform duration-300 border-4 border-dracula-background"
            ></div>

            <!-- Content Card -->
            <div class="ml-20">
              <div
                class="bg-dracula-selection border border-gray-500 rounded-lg p-8 group-hover:border-dracula-purple/50 hover:shadow-lg hover:shadow-dracula-purple/10 transition-all duration-300 hover:-translate-y-1 backdrop-blur-sm"
              >
                <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-6">
                  <div class="flex-1">
                    <h3
                      class="text-2xl font-bold text-dracula-foreground mb-2 group-hover:text-dracula-purple transition-colors duration-300 font-mono"
                    >
                      {{ experience.position }}
                    </h3>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:gap-4 mb-4">
                      <div
                        class="flex items-center gap-2 text-dracula-purple font-semibold font-mono"
                      >
                      ...
                      <div class="flex items-center gap-2 text-dracula-comment font-mono">
